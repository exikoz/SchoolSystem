    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            using (var context = new SchoolSystemContext())
            {
                ...
                var menu = new MainMenu(new StudentService(context), new ClassroomService(context), new TeacherService(context), new CourseService(context), new ScheduleService(context), new EnrollmentService(context), new GradeService(context));
                menu.UseMainMenu();
